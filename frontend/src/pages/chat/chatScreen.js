...
class App extends React.Component {
    ...
    handleSendChange = (e) => {
        ...
        this.setState({ sendTerm: currentInput });
    }

    handleSendSubmit = () => {
        const newMessage = this.state.sendTerm;

        if (newMessage) {
            this.setState((prevState) => ({
                messages: [
                    ...prevState.messages,
                    { text: newMessage, isYellow: prevState.messages.length % 2 === 0 },
                ],
                sendTerm: '', // Clear the input field
            }));
        }
    }
                    ...
                    <div className='row'>
                                ...
                                <div className='col-lg-10' style={SummarizeChatsColumn}>
                                    ...
                                    <div className='searchComponent' style={searchComponent}>
                                        <input
                                            ...
                                            style={inputStyle}
                                        />
                                        <button onClick={this.handleSearchSubmit} style={searchButton}>Search</button>
                                    </div>
                        ...
                        <div className='col-lg-8' style={messagesAreaStyle}>
                            ...
                            <div className='messagePopUpArea' style={scrollViewStyle}>
                                <div style={this.state.messages.length % 2 === 0 ? grayContentStyle : contentStyle}>
                            ...
                            <div className='bottomBarDiv' style={bottomBarDivStyle}>
                                <div className='searchComponent' style={writeComponent}>
                                    <input
                                        type="text"
                                        placeholder="Search..."
                                        value={this.state.sendTerm}
                                        onChange={this.handleSendChange}
                                        style={textInputStyle}
                                    />
                                    <button onClick={this.handleSendSubmit} style={sendButton}>Send</button>
                                </div>
                            </div>
                        </div>
                    </div>
